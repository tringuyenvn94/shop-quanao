...
{
    public partial class hoadon_list : System.Web.UI.UserControl
    {
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("~/Admin/hoadons.aspx?module=view&ID=" + e.CommandArgument);
            }

            if (e.CommandName.ToLower().Equals("update"))
            {
                ucConfirmDialog.MessageContent = "Bạn có chắc chắn duyệt hóa đơn này?";
        ...
        private void FillData(int pageIndex)
        {
            ...
            try
            {
                ...
                Repeater1.DataSource = vcontroller.getall_hoadon_page(pageIndex, pageSize, ref rowCount, ref errMsg);
