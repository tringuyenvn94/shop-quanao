...
{
    public partial class user_list : System.Web.UI.UserControl
    {
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("~/Admin/users.aspx?module=update&ID=" + e.CommandArgument);
            }
            if (e.CommandName.ToLower().Equals("update1"))
            {
                ucConfirmDialog.MessageContent = "Bạn có chắc chắn muốn thay đổi trạng thái user này?";
        ...
        {
            Response.Redirect("~/Admin/users.aspx?module=add");
        }
        ...
        private void FillData(int pageIndex)
        {
            ...
            try
            {
                ...
                Repeater1.DataSource = vcontroller.getall_khachhang_page(true,pageIndex, pageSize, ref rowCount, ref errMsg);
