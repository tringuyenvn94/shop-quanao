...
{
    public partial class Size_list : System.Web.UI.UserControl
    {
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("~/Admin/Sizes.aspx?module=update&ID=" + e.CommandArgument);
            }
            if (e.CommandName.ToLower().Equals("delete"))
            {
                ucConfirmDialog.MessageContent = "Bạn có chắc chắn muốn xóa size này?";
        ...
        {
            Response.Redirect("~/Admin/Sizes.aspx?module=add");
        }
        ...
        private void FillData(int pageIndex)
        {
            ...
            try
            {
                ...
                Repeater1.DataSource = vcontroller.getall_Size_page(pageIndex, pageSize, ref rowCount, ref errMsg);
